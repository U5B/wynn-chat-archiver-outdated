...
colorexport.mccolor = function (str) {
...
colorexport.r = function (msg) { return '§r' + msg + '§r' }
// COMMENT: strip all ansi or color codes
// function stripansi (str) { return str.replace(/\[\d+\w/g, '') }
colorexport.stripthes = function (str) { return str.replace(/§(?:[0-9a-z])/g, '') }
module.exports = colorexport
